        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('org.update') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('business_operation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="business_operation" type="text" class="form-control" name="business_operation" value="{{ old('business_operation') }}" required>
