...
class CreateBowlerMasterTable extends Migration {
	...
	public function up()
	{
		Schema::create('bowler_master', function(Blueprint $table)
		{
			...
			$table->string('bowler_type')->nullable();
